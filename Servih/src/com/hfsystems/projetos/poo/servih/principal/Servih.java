    ...
    public static void Op1(Vendedor v, Empresa Emp, Deposito Dep, CatalogoProd Catalogo) throws IOException{
        ...
        switch (i){
            ...
            case 2:
                    ...
                    if(Emp.getCata().getProd().isEmpty()){
                        ...
                        for(int k = 0; k < Emp.getCata().getProd().size(); k++){
                            ...
                            System.out.println("\t\t\tPreco: "+Emp.getCata().getProd().get(k).getPreco());
            ...
            case 3:
                ...
                code = l.nextInt();
                int indice = searchProdEmp(Emp, code);
                if(indice == -1){
                    break;
                }
                else if(indice == -2){
                            ...
                            for(int l = 0; l < Emp.getNota().size(); l++){
                                if(Emp.getNota().get(l).getCli().getCPF() == Emp.getCli().get(indice).getCPF()){
                                    ...
                                    for(int o = 0; o < Emp.getNota().get(l).getProd().size(); o++){
                                        ...
                                        System.out.println("\t\t\tPreco Unitário: "+Emp.getNota().get(l).getProd().get(o).getPreco());
                                        System.out.println();
                                        qtd++;
                                    }
                                    System.out.println("\t\t\tQuantidade de Produtos: "+qtd);
                                    System.out.println("\t\t\tValor Total: "+Emp.getNota().get(l).getValorCompra());
                            ...
                            int  i = 1;
                                while(i == 1){
                                    if(i == 1){
                                        ...
                                        System.out.println("\t\t\tValor total compra: "+nota.getValorCompra());
                                        ...
                                        System.out.println("\t\t\tVender mais: [1] = SIM\n\t\t\t[2] = NÃO");
                                        i = k.nextInt();
